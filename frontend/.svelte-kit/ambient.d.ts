...
declare module '$env/static/private' {
	export const KITE_PASSWORD: string;
	...
	export const MAX_FUND_PERCENTAGE_PER_TRADE: string;
	export const npm_config_noproxy: string;
	export const KITE_USER_ID: string;
	export const HOME: string;
	export const CHROME_DESKTOP: string;
	export const LOCPATH_VSCODE_SNAP_ORIG: string;
	export const TERM_PROGRAM_VERSION: string;
	export const DESKTOP_SESSION: string;
	export const DEFAULT_STRIKE_GAP_POINTS: string;
	...
	export const KITE_ACCESS_TOKEN: string;
	export const BACKEND_PORT: string;
	export const LOGNAME: string;
	export const BROKER_TYPE: string;
	...
	export const KITE_API_SECRET: string;
	...
	export const DEFAULT_SELL_TARGET_PERCENTAGE: string;
	...
	export const KITE_REDIRECT_URL: string;
	...
	export const KITE_API_KEY: string;
	export const MEMORY_PRESSURE_WRITE: string;
	export const MARKET_DATA_REFRESH_INTERVAL: string;
	export const KITE_POSTBACK_URL: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		SHLVL: string;
		MAX_FUND_PERCENTAGE_PER_TRADE: string;
		...
		DEFAULT_STRIKE_GAP_POINTS: string;
		GTK_PATH: string;
		NVM_BIN: string;
		...
		GDMSESSION: string;
		DEFAULT_SELL_TARGET_PERCENTAGE: string;
		LESSCLOSE: string;
		...
		MARKET_DATA_REFRESH_INTERVAL: string;
		KITE_POSTBACK_URL: string;
		APP_VERSION: string;
		INIT_CWD: string;
		EDITOR: string;
		NODE_ENV: string;
